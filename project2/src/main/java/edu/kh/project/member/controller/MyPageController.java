...
@Controller // 이 클래스가 Controller임을 인식시켜줌 + bean 등록(IOC)
public class MyPageController {
    ...
    // 내 정보 페이지 이동
    @GetMapping("/info") // 나머지 주소 작성(/member/myPage가 생략됨)
    public String info() {
    ...
    public String updateInfo(Member inputMember, String[] memberAddress,
        ...
        // inputMember : 입력받은 memberNickname / memberTel / memberAddress
        ...
        // 다운캐스팅 해가며 세션 정보를 loginMember에 담음
    ...
    public String memberDelete(@SessionAttribute("loginMember") Member loginMember,
        ...
        // 클래스 레벨에 작성된
        // @SessionAttribuytes("key")에 작성된
        // key가 일치하는 값만 무효화
        
        // ex) session에서 "loginMember"를 없애야 함
        //     @SessionAttributes("loginMember")
        //     ...
    ...
    // MultipartFile
    // MultipartResolver에 의해서 반환딘
    // input type="file의 값을 저장한 객체
    ...
    public String updateProfile(@RequestParam(value="profileImage") MultipartFile profileImage,
                                ...
                                HttpServletRequest req) throws Exception { // 저장할 서버 경로
