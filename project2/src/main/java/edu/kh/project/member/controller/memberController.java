...
public class MemberController {
	...
	// [조건]
	// - name 속성 값과 필드명이 같아야함
	// - VO에 반드시 기본 생성자가 존재해야함
	// - VO에 반드시 setter가 존재해야함
	
	// @ModelAttribute 어노테이션 생략도 가능!
	// == 커맨드 객체
	
	// * 참고 *
	// Contorller 메서드 매개변수에 객체를 작성하면
	// 자동으로 생성되거나 얻어올 수 있는 이유
	// Spring Container에서 Argument Resolver(매개변수 해결사)를
	// 제공해서 유연하게 처리
	...
	public String login(/* @ModelAttribute*/ Member inputMember,
						...
						@RequestParam(value="saveId", required=false) String saveId, // 체크박스
...
//			model.addAttribute("message", "아이디 또는 비밀번호가 일치하지 않습니다");
    ...
    public String signUp(Member inputMember /* 커맨드 객체 */,
                         String[] memberAddress /* name 속성 값이 memberAddress인 값을 배열로 변환*/,
                         RedirectAttributes ra,
        ...
        // 주소가 작성된 경우 ==> 주소,,주소,,주소
            ...
            // String.join(",,", memberAddress) : memberAddress에 있는 문자열을 ,,로 연결하면서 합치기
