...
import edu.kh.project.member.model.vo.Member;
	...
	// @Service("이름") : bean 등록 시 이름을 클래스명으로 등록(memberServiceImpl) 
	// @Service			: bean 등록 시 이름을 지정된 이름으로 등록
